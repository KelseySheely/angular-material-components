 ...
 */
  ...
  */
  ...
  copyTime(toDate: D, fromDate: D): D {
    const hourDate = this.setHour(toDate, this.getHour(fromDate));
    const minuteDate = this.setMinute(hourDate, this.getMinute(fromDate));
    return this.setSecond(minuteDate, this.getSecond(fromDate));
  }
 ...
 */
  ...
  setTimeByDefaultValues(date: D, defaultTime: number[]): D {
    ...
    const hourDate = this.setHour(date, defaultTime[0] || 0);
    const minuteDate = this.setMinute(hourDate, defaultTime[1] || 0);
    return this.setSecond(minuteDate, defaultTime[2] || 0);
  }
